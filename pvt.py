...
KEY_COST = {"1hour": 30, "1days": 80, "7day": 150, "1months": 500, "6month": 1500}
...
def start_command(message):
    ...
    bot.reply_to(message, "𝗪𝗲𝗹𝗰𝗼𝗺𝗲 𝘁𝗼 *𝗥𝗮𝗛𝗨𝗟 𝘅 𝗗𝗜𝗟𝗗𝗢𝗦™* 𝗣𝗨𝗕𝗟𝗜𝗖 𝗕𝗢𝗧 !", reply_markup=markup, parse_mode='Markdown')
    bot.send_message(
        message.chat.id,
...
def generate_key(message):
    ...
    if len(command) != 2:
        bot.reply_to(
            message,
            "➖ 𝗨𝘀𝗮𝗴𝗲: /𝗴𝗲𝗻𝗸𝗲𝘆 <𝗱𝘂𝗿𝗮𝘁𝗶𝗼𝗻> \n\n⚙️ 𝘼𝙑𝘼𝙄𝙇𝘼𝘽𝙇𝙀 𝙆𝙀𝙔 '𝙨 & 𝘾𝙊𝙎𝙏 : \n     ➖ 𝟭𝗵𝗼𝘂𝗿 : 𝟯𝟬 𝗥𝘀    { `/genkey 1hour` }\n     ➖ 1𝗱𝗮𝘆 : 𝟴𝟬 𝗥𝘀    { `/genkey 1day` }\n     ➖ 7𝗱𝗮𝘆𝘀 : 𝟭𝟱𝟬 𝗥𝘀    { `/genkey 7days` }\n     ➖ 1𝗺𝗼𝗻𝘁𝗵𝘀 : 𝟱𝟬𝟬 𝗥𝘀    { `/genkey 1months` }\n     ➖ 6𝗺𝗼𝗻𝘁𝗵 : 𝟭𝟱𝟬𝟬 𝗥𝘀   { `/genkey 6months` } \n\n                  ‼️  𝗧𝗔𝗣 𝗧𝗢 𝗖𝗢𝗣𝗬  ‼️",
            parse_mode='Markdown'
        )
        return
